...
**Description:** The system shall be implemented on an ESP microcontroller (ESP32).  
...
#### REQ.OTA.220 – OTA Trigger via Website

**Description:** The firmware OTA process shall be triggerable via the web interface.  
